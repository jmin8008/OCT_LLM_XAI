...
\textbf{Reproducibility.} All artifacts --- per-experiment code archives \texttt{train\_expN.py}, \texttt{results.json} logs, \texttt{changelog.md} narratives, and harness \texttt{context.md}/\texttt{program.md} files --- are available at \url{https://github.com/jmin8008/OCT\_LLM\_XAI}. Every numeric in this manuscript can be re-derived from the bundled \texttt{results.json} logs and the deterministic seeds documented therein.
