...
\textbf{Reproducibility.} All artifacts --- per-experiment code archives \texttt{train\_expN.py}, \texttt{results.json} logs, \texttt{changelog.md} narratives, and harness \texttt{context.md}/\texttt{program.md} files --- will be released upon acceptance. Every numeric in this manuscript can be re-derived from the bundled \texttt{results.json} logs and the deterministic seeds documented therein.
