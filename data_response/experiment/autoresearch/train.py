#!/usr/bin/env python3
"""
APTOS 2021 AutoResearch Exp #12: Multi-seed Ensemble
Exp #5(0.9475) 코드를 그대로 사용하되 3개 seed로 독립 학습 후 예측 평균.
단일 seed의 variance를 줄여 더 안정적이고 높은 AUC 달성 목표.

Runs 3 seeds sequentially within TIME_BUDGET:
- seed=42: ~300s (6 epochs)
- seed=123: ~300s
- seed=2024: ~300s
Each seed gets TIME_BUDGET/3 seconds. Predictions averaged across all 3.
...
SEED_TIME_BUDGET = TIME_BUDGET // len(ENSEMBLE_SEEDS)  # 300s per seed
