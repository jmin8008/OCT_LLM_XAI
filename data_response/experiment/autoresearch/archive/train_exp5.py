#!/usr/bin/env python3
"""
APTOS 2021 AutoResearch Exp #5: ConvNeXt-Tiny + MIL Max Pool + MixUp
Exp #4A(0.9418) 기반: MixUp(alpha=0.2, prob=0.5) 추가로 과적합 지연.
...
- Exp #5: ConvNeXt-Tiny + MixUp, lr=1e-4, warmup=5, dropout=0.3, wd 1e-4, batch=8
"""
